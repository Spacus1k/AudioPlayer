...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    private fun preparePlayer(
        ...
        val indexToPlay = if (currentPlayingAudio == null) 0
    ...
    private inner class PlayerEventListener : Player.Listener {
        ...
        override fun onPlaybackStateChanged(playbackState: Int) {
            when (playbackState) {
                ...
                Player.STATE_READY -> mediaPlayerNotificationManager.showNotification(exoPlayer)
                else -> mediaPlayerNotificationManager.hideNotification()
            }
        }
    ...
    inner class MediaQueueNavigator(mediasSessionCompat: MediaSessionCompat) :
    ...
    inner class AudioPlayBackPreparer : MediaSessionConnector.PlaybackPreparer {
        ...
        override fun onPrepareFromMediaId(
            ...
            mediaSource.whenReady {
                val itemTopPlay = mediaSource.audioMetaData.find {
                    it.description.mediaId == mediaId
                }

                currentPlayingAudio = itemTopPlay

                preparePlayer(
                    mediaSource.audioMetaData, itemTopPlay, playWhenReady
                )
            }
        }
